            ...
            if (jsonResults.has("results")) {
                ...
                for (int i = 0; i < newsArray.length(); i++) {
                    ...
                    if (currentNewsItem.has("webPublicationDate")) {
                        newsDate = currentNewsItem.getString("webPublicationDate");
                    }
